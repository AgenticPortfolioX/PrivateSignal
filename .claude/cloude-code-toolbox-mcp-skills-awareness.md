...
_Generated: 2026-09-04T08:05:54.767Z_
...
Workspace `mcp.json` _(folder: privatesignal)_

- **c:\Users\jmgra\antigravityagents\.agents\workflows\privatesignal\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\jmgra\.claude.json** — _File exists — no servers defined_
