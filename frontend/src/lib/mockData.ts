...
export const SAMPLE_QUERY_RESULTS: Record<string, ScoreResponse> = {
  sample: {
    ...
    attestation: {
      ...
      signature: '0xattest_8f2d9c1e45a7b03681fe29d3c509a27e',
      timestamp: Math.floor(Date.now() / 1000) - 180,
      verified: true,
    },
    attestationSummary: {
      ...
      workflowId: 'privatesignal-confidential-v1',
      executionHash: '0x8f2d9c1e45a7b03681fe29d3c509a27e43bc91f8a20d4e56b82c31e9a04f7b2c',
      signatureSnippet: '0xattest_8f2d9c...09a27e',
      verified: true,
      status: 'VERIFIED_ENCLAVE_EXECUTION',
      formattedTimestamp: 'Sep 4, 2026, 7:12:00 PM EDT',
      shortHash: '0x8f2d9c1e...a04f7b2c',
      donZone: 'Chainlink Production TEE (SGX/TDX)',
    },
    featuresSummary: {
  ...
  caution: {
    ...
    attestation: {
      ...
      signature: '0xattest_3a4b5c6d7e8f90123456789abcdef012',
      timestamp: Math.floor(Date.now() / 1000) - 600,
      verified: true,
    },
    attestationSummary: {
      ...
      workflowId: 'privatesignal-confidential-v1',
      executionHash: '0x3a4b5c6d7e8f90123456789abcdef0123456789abcdef0123456789abcdef01',
      signatureSnippet: '0xattest_3a4b5c...def012',
      verified: true,
      status: 'VERIFIED_ENCLAVE_EXECUTION',
